...
| **1.3** | [`03-transport-routing-policy-engine-architecture.md`](sys-arch/03-transport-routing-policy-engine-architecture.md) | **200** | **127/200 (64%)** | [`siar-routing-policy`](crates/siar-routing-policy), [`siar-connectivity`](crates/siar-connectivity) | **ACTIVE FOCUS**: Path authorization, extension capabilities, device capabilities. Next: §108+ |
...
| 03 | [Transport & Routing Policy](sys-arch/03-transport-routing-policy-engine-architecture.md) | 200 | 127/200 (64%) | Milestone 1 (Active) |
...
Current Status   : 127 / 200 Sections (64% Reconciled, 139/139 Tests Passing)
```
...
2. **Next Batch (Round 11)**: Implement sections **§108 onward** of Spec 03:
