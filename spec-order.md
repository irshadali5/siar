...
| **1.3** | [`03-transport-routing-policy-engine-architecture.md`](sys-arch/03-transport-routing-policy-engine-architecture.md) | **200** | **135/200 (68%)** | [`siar-routing-policy`](crates/siar-routing-policy), [`siar-connectivity`](crates/siar-connectivity) | **ACTIVE FOCUS**: Deep policy layering, policy conflict resolution, decision results. Next: §116+ |
...
| 03 | [Transport & Routing Policy](sys-arch/03-transport-routing-policy-engine-architecture.md) | 200 | 135/200 (68%) | Milestone 1 (Active) |
...
Current Status   : 135 / 200 Sections (68% Reconciled, 150/150 Tests Passing)
```
...
2. **Next Batch (Round 12)**: Implement sections **§116 onward** of Spec 03:
   * UI-Friendly State (§116)
   * Route Policy Configuration (§117)
   * Routing Engine & Transport Manager APIs (§118–§120)
